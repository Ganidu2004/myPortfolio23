    ...
    const projectsData = [
        {
            ...
            link: 'https://github.com/Ganidu2004/doctor_appoinment_app'
        },
        {
            id: 2,
            image: project2,
            ...
            link: 'https://www.auracosmetics.ddnsfree.com/contact'
        }
    ]
    ...
    <section id='projects' className='py-20 relative overflow-hidden'>
        <div className='container mx-auto px-4 sm:px-8 lg:px-14 relative z-10'>
            ...
            <div
                ...
                data-aos='fade-up'
                data-aos-delay='100'
                className='flex gap-6 no-scrollbar snap-x snap-mandatory overflow-x-auto w-full px-2 py-4'>
